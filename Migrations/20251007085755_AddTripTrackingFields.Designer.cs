...
namespace EcsFeMappingApi.Migrations
{
    ...
    [Migration("20251007085755_AddTripTrackingFields")]
            ...
            modelBuilder.Entity("EcsFeMappingApi.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 7, 8, 57, 53, 449, DateTimeKind.Utc).AddTicks(6999),
                            PasswordHash = "$2a$11$L4Yjuczpwa.AI0QEVK.lVuiGWQGG08Eb6CFG0qh1j7dww1YRXMmh2",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
