...
namespace EcsFeMappingApi.Migrations
{
    ...
    [Migration("20251020031446_AddRoutePathToActivityEvent")]
    partial class AddRoutePathToActivityEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcsFeMappingApi.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 20, 3, 14, 44, 932, DateTimeKind.Utc).AddTicks(2517),
                            PasswordHash = "$2a$11$UKtPOBHSFoI32mluFoVbVemXevAdfAg18zUkpcXWLw3G2AgY95rwm",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
