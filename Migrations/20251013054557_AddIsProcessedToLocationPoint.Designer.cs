...
namespace EcsFeMappingApi.Migrations
{
    ...
    [Migration("20251013054557_AddIsProcessedToLocationPoint")]
    partial class AddIsProcessedToLocationPoint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcsFeMappingApi.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 13, 5, 45, 56, 650, DateTimeKind.Utc).AddTicks(91),
                            PasswordHash = "$2a$11$VtMYOJjDiLqPrpwsdBIdL.aAujuIsKYv.KGNOAlN/CmLRwqt5SCaO",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
